<?php
/************************************************************
Plugin Name: Greeky - Contact Information
...
* @since 0.1
*/
add_action('widgets_init', 'greeky_register_widget_contact_information');
function greeky_register_widget_contact_information(){
    register_widget('greeky_widget_contact_information');}
/**
* greeky_widget_contact_information class.
* This class handles everything that needs to be handled with the widget:
* the settings, form, display, and update.  Nice!
*
* @since 0.1
*/
class greeky_widget_contact_information extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'greeky_widget_contact_information',
            'Greeky - Contact Information',
            array( 'description' => esc_html('Display information in contact page','greeky'))
            );
    }
/**
* Display the widget
...
<p>
    <label for="<?php echo esc_attr($this->get_field_id('description')); ?>">
        <?php echo esc_html("Desctiption ","greeky"); ?></label>
...
<p>
    <label for="<?php echo esc_attr($this->get_field_id('address')); ?>">
        <?php echo esc_html("Address ","greeky"); ?></label>
...
<p>
    <label for="<?php echo esc_attr($this->get_field_id('email')); ?>">
        <?php echo esc_html("Email ","greeky"); ?></label>
...
<p>
    <label for="<?php echo esc_attr($this->get_field_id('phone')) ; ?>">
        <?php echo esc_html("Phone ","greeky"); ?></label>
...
<p>
    <label for="<?php echo esc_attr($this->get_field_id('time')) ; ?>">
        <?php echo esc_html("Time Open Hours  ","greeky"); ?></label>
