...
var token = "";
$(document).on('click', '.z0', function () {
    console.log(" tra ve dau");
    ...
    var iframe = $('.mixmax-mole .mixmax-loading-screen iframe')
    // var button = iframe.contentDocument.getElementsById("buttonId");
    console.log(iframe);
    setTimeout(function () {
        console.log(iframe.contents().find('.xT'));

    }, 3000);



    //  var iframe = $('.db-lightbox iframe')
    // var button = iframe.contentDocument.getElementsById("buttonId");
    // console.log(iframe);


    // setTimeout(function () {
    // console.log(iframe.contents().find("#panel-left"));
    //  }, 5000);
