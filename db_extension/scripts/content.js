...
$(document).on('click', '.z0', function () {
    ...
    var html = `<a class='db-btn-designit' title="design it"></a>`;
    setTimeout(function () {
        if ($('.db-btn-designit').is(":visible")) {} else {
            var iframe = $('.bAK');
            console.log(iframe);
            iframe.append(html);
        }
