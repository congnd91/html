   ...
   var leftCotrol_num=0;
    $('.leftCotrol .fa-chevron-up').click(function(event) {
    var query = Modernizr.mq('(max-width: 1024px)');
         if (query) {
            leftCotrol_num--;
            if(leftCotrol_num<0)
            ...
            $('.leftCotrol ul li').removeClass('leftCotrol_li_active');
            $('.leftCotrol ul li').eq(leftCotrol_num).addClass('leftCotrol_li_active');
         } else {
             
         }
   });
       $('.leftCotrol .fa-chevron-down').click(function(event) {
  

               var query = Modernizr.mq('(max-width: 1024px)');
         if (query) {
            leftCotrol_num++;
            if(leftCotrol_num==12)
            {
                leftCotrol_num=0;
            }
            $('.leftCotrol ul li').removeClass('leftCotrol_li_active');
        ...
        var rightCotrol_num=0;
    $('.rightCotrol .fa-chevron-up').click(function(event) {
       var query = Modernizr.mq('(max-width: 1024px)');
         if (query) {
            rightCotrol_num--;
            if(rightCotrol_num<0)
            {
                rightCotrol_num=$('.rightCotrol ul li').length-1;
            }
            $('.rightCotrol ul li').removeClass('rightCotrol_li_active');
            $('.rightCotrol ul li').eq(rightCotrol_num).addClass('rightCotrol_li_active');
         } else {
             
         }
   });
       $('.rightCotrol .fa-chevron-down').click(function(event) {
    
          var query = Modernizr.mq('(max-width: 1024px)');
         if (query) {
            rightCotrol_num++;
            if(rightCotrol_num==$('.rightCotrol ul li').length)
            {
                rightCotrol_num=0;
            }
            $('.rightCotrol ul li').removeClass('rightCotrol_li_active');
  ...
  $('.noSign .fa-chevron-right').click(function(event) {
       if (activeX) {

            page_04_lft_go();
         }
     });
     $('.noSign .fa-chevron-left').click(function(event) {
       if (activeX) {
