(function ($) {
  $(document).on('ready', function () {
    ...
    db.closeBox = function () {
      ...
      $('.apply-button-mobile-wrap a').on('click', function (e) {
        $('.apply-form').show();
        $('html,body').animate({
          scrollTop: $(".jd-des-control").offset().top
        }, 0);
        return false;
      });
      //**
      ...
      $(document).on('click', '.rj-list .item .close-item', function (e) {
        $(this).parent().hide();
      });
      //
      ...
      $('.dots-share .icon').on('click', function (e) {
        e.stopPropagation();
    ...
    db.validate = function () {
      ...
      if ($('.form-receive-job').length) {
        $('.form-receive-job').validate();
      };
    ...
    db.addJob = function () {
      ...
      $('.rj-interested p').click(function () {
        $(this).hide();
        $('.rj-list').append('<div class="item"><div class="icon"></div> <span>' + $(this).text() + '</span><div class="close-item"><i class="fas fa-times"></i</div></div>')
      });
    ...
    db.scroll = function () {
      /*
            $(window).scroll(function () {
              ...
              if ($(this).scrollTop() > $('.meta-apply').offset().top + 50) {

                $('.apply-mobile-wrap').show();
              } else {
                $('.apply-mobile-wrap').hide();
              }
            });*/
    ...
    db.popup = function () {
      ...
      if ($('.db-category-bar').length) {
        const slider5 = document.querySelector('.db-category-bar .db-scroll');
        let isDown5 = false;
        let startX5;
        let scrollLeft5;
        ...
        slider5.addEventListener('mousemove', (e) => {
          if (!isDown5) return;
          const x5 = e.pageX - slider5.offsetLeft;
          const walk5 = (x5 - startX5) * 3; //scroll-fast
          slider5.scrollLeft = scrollLeft5 - walk5;
        });
      };
    }
