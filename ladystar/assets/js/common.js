...
jQuery(document).ready(function ($) {
    ...
    $('.navigation .menu-item-has-children > .sub-menu').before('<span class="sub-menu-toggle"></span>');
    // toggle mobile menu
    $('.fa-bars').on('click', function () {
        navigation_wr.toggleClass('active');
    })
    ...
    //share buttons
    $('.post-footer .share a').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $('.images-gallery a.preview').on('click', function (e) {
        ...
        var options = {
            index: curIndex, onslide: function (index, slide) {
