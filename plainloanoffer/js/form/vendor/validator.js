    ...
    FormValidator.prototype = {
        ...
        texts : {
            ...
            complete        : 'input is not complete',
             regex : {
                alphanumeric: 'please enter alphanumberic characters only',
                 bank        : 'please enter alphanumberic characters only',
                alpha: 'please enter alphabetic characters only',
                numeric: 'please enter numeric characters only',
                phone: 'please enter numeric characters only',
            }
        },
                ...
                if( data.pattern ){
                    ...
                    switch( data.pattern ){
                        ...
                        case 'phone' :
                            ...
                            break;
                        case 'alpha' :
                            regex = this.settings.regex.alpha
                            break;
                         case 'bank' : // Custom case.
                            regex = this.settings.regex.bank
                            break;
                        default :
                            regex = data.pattern;
                    }
                    try{
                        ...
                        if( data.value && !jsRegex ){
                             // Custom code by LMSACE.
                            pattern = data.pattern;
                            if (this.texts.regex[pattern] != '') {
                                return this.texts.regex[pattern]
                            }
                            // E.o Custom code.
        ...
        mark : function( field, text ){
            ...
            setTimeout(function(){
            	item.classList.remove( that.settings.classes.good );
        ...
        */
        unmark : function( field ){
            ...
            if( fieldWrap ){
                ...
                fieldWrap.classList.add(this.settings.classes.good);
            }
