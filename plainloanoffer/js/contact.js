$(function () {
    ...
    var blinkErrorElements = function () {
        var colorArray = new Array("#fff", "#fde5e5", "#FFFFFF", "#fde5e5", "#FFFFFF", "#fde5e5");
        ...
        var submitBtn = form.find('a.btn'),
			submitHandler = function () {
			    ...
			    if (form.valid()) {
			        ...
			        $.ajax(
						{
						    url: targetUrl + '?action=contactus&responsetype=json&uid=' + lmpost.options.hituid + '&clienturl=' + escape(location.href) + '&' + query,
						    type: 'get',
						    dataType: 'jsonp',
						    dataType: 'jsonp',
