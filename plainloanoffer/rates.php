            ...
            <div class="section">
                <div class="container">
                    <div class="text_content">
                        <h1>Rates &amp; Fees</h1>
                        <p>
                            Our service is always FREE. The rates and fees applicable to your loan will be set by your lender. We are not a lender and does not provide lending services directly to consumers. We use the information you submit to quickly and conveniently connect you
                            with a lender.
                        </p>
                        <strong><p class="h4">Full Disclosure of Terms</p></strong>
                        <p>The Truth in Lending Act requires full disclosure of all loan fees and interest rates. Your lender should disclose all fees and rates to you before you accept your loan. If you accept the loan terms, most lenders will direct you
                            to an e-signature page to complete the loan process. Please take the time to read your loan agreement before accepting and signing it.</p>
                        <strong><p class="h4">Late Payment Policy</p></strong>
                        <p>Lenders may have different policies regarding late payments. Review the late payment policy detailed in your loan agreement before signing. All lenders must abide by applicable laws, rules, and regulations regarding late payment
                            fees.
                        </p>
                        <strong><p class="h4">Non-Payment Policy</p></strong>
                        <p>Additional fees or charges may apply in the event that you are unable to repay your loan. We try to work with reputable lenders dedicated to using lawful, fair and reasonable means to pursue collections of overdue accounts.</p>
                        <strong><p class="h4">Loan Renewal Policy</p></strong>
                        <p>Loan renewal policies are largely governed by state law. In states where renewals are allowed, additional interest and late fees can add substantial to your final loan amount, so these should be avoided whenever possible. Read
                            the lender's terms in considering renewal options before signing the loan agreement.</p>
                        <p>* Please note that this list is for informational purposes only, is not intended to be legal advice, and may not be accurate or up to date at all times. If you have a specific question about laws or regulations applicable to you,
                            please ask your lender directly or consult a legal adviser. Some states do not have any lending statutory provisions pertaining to personal loans.
                        </p>
                    </div>
                </div>
            </div>
