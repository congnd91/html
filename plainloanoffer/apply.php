                ...
                <div class="box-page">
                    ...
                    <div class="control-group field">
                     ...
                     <div class="control-group field">
                        ...
                        <div class="control-group__control">
                        <input type="text" placeholder="City" name="City" maxlength="50" id="City" value="" class="frm-required valid" data-validate-length-range="2" required>
                        </div>
                    </div>
                     ...
                     <div class="control-group field">
                        ...
                        <div class="control-group__control">
                       <div class="control-select">
                            <select name="State" id="State" class="frm-required valid" required>
