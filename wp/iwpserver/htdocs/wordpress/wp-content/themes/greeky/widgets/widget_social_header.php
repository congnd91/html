<?php
/************************************************************
Plugin Name: Greeky - Social Icons Header
Description:   Display social network icons in header
Author: CizThemes
...
class greeky_widget_social extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            'Greeky - Social Icons',
            array( 'description' =>  esc_html('Display social network icons in header','greeky'))
            );
    }
/**
* Display the widget
