<?php
/************************************************************
Plugin Name: Globargo - Home About
Description:   Display About in home page
Author: CizThemes
...
* @since 0.1
*/
add_action('widgets_init', 'globargo_register_widget_home_about');
...
function globargo_register_widget_home_about(){
    register_widget('globargo_widget_home_about');}
/**
* 
...
* @since 0.1
*/
class globargo_widget_home_about extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'globargo_widget_home_about',
            'Globargo - Home About',
            array( 'description' =>esc_html('Display About in home page','globargo'))
            );
    }
/**
* Display the widget
